...
ehco  "sh reconfigure_pm_hive.sh $TARGET_HOST $TARGET_PORT $TARGET_USER $TARGET_PASS $TARGET_DB $TARGET_CRC_SCHEMA $TARGET_ONT_SCHEMA $TARGET_PM_SCHEMA $TARGET_HIVE_SCHEMA $TARGET_WD_SCHEMA $CORE_SERVER_IP $CORE_SERVER_PORT"
