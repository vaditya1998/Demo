...
if [ "$TARGET_SERVER" = "localhost" ]; then
    ...
    docker run -i -e "ACCEPT_EULA=Y" -e "SA_PASSWORD=<YourStrong@Passw0rd>" -p 1432:1433 --name target_db_container -d docker.io/library/custom-mssql-2019-fts:latest  #mcr.microsoft.com/mssql/server:2019-latest
